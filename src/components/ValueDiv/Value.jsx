    ...
    <div className='mb-[4rem] mt-[6rem]'>
      <h1 className='text-textColor text-[25px] py-[2rem] pb-[3rem] font-bold w-[400px]
        ...
        <div className='grid gap-[10rem] grid-cols-3 items-center'>
          ...
          <div className='singleGrid rounded-[18px] hover:bg-[#f7edf5] p-[1.5rem]'>
            <div className='flex items-center gap-3'>
              <div className='imgDiv p-[4px] rounded-[.8rem] bg-[#f7d1e1] h-
              [40px] w-[40px] flex items-center justify-center'>
                 <img src={simple} alt="" className='w-[70%]' />
              </div>
          ...
          <div className='singleGrid rounded-[18px] hover:bg-[#fcfae3] p-[1.5rem]'>
            <div className='flex items-center gap-3'>
