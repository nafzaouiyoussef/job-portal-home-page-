...
const Search = () => {
  return (
    <div className='searchDiv grid gap-10 bg-greyIsh rounded-[10p] p-[3rem]'>
        ...
        [10px] bg-white p-5 shadow-lg shadow-greyIsh-700 '>
            ...
            <div className='flex gap-2 items-center'>
                ...
                <input type="text" className='bg-transparent text-blue-500 focus:outline-none
                    w-[100%] 'placeholder='Search Job Here....' />
          ...
          <button className='bg-blueColor h-full p-5 px-10 rounded-[10px] text-white cursor-pointer
          hover:bg-blue-300'>
            Search</button>
